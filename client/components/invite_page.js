    ...
    render(){      
        ...
        return(<div className='mainContainer' style={{width:'100%'}}>
            ...
            <div style={{width:'100%', minHeight:'270px', backgroundColor:'#FF7000', color:'white', display:'flex'}}>
                <div className='InvitePage_profitDiv' style={{minWidth:'240px', padding:'0 15px', minHeight:'215px', margin:'auto', display:'flex'}}>
                    ...
                    <div style={{minWidth:'240px', display:'flex'}}>
            ...
            <div className='InvitePage_bannerComponet' style={{width:'100%', height:'185px', paddingTop:'25px', backgroundColor:'#F2F2F2', position:'relative'}}>
                <div className='InvitePage_bannerMain' style={{width:'635px', height:'185px', paddingLeft:'35px', position:'relative', margin:'0 auto'}}>
                    <div className='InvitePage_bannerPart1' style={{width:'540px', height:'185px', backgroundColor:'white', display:'flex', position:'absolute', left:'35px', top:'0px'}}></div>
                    <div className='InvitePage_bannerPart2' style={{width:'96px', height:'185px', backgroundImage:'url(/imgs/others/inviteBanner2.png)', backgroundSize:'contain', backgroundPosition:'right center', backgroundRepeat:'no-repeat', display:'flex', position:'absolute', left:'575px', top:'0px'}}></div>
                    <div className='InvitePage_bannerPart3' style={{width:'fit-contet', height:'185px', maxWidth:'550px', display:'flex', position:'absolute', left:'35px', top:'0px'}}>                
                        <img src='/imgs/others/inviteBanner.png' height='100%'/>
                        <div className='InvitePage_bannerPart4' style={{width:'285px', height:'fit-content', paddingLeft:'0px', margin:'auto 0'}}>
                            <div className='InvitePage_bannerPart5' style={{width:'fit-content', height:'fit-content'}}>
                                <div className='InvitePage_bannerTitle' style={{fontSize:'23px', paddingBottom:'5px', color:'#FF7000', textAlign:'right'}}>A SOLUÇÃO PARA VOCÊ!</div>
                                <div className='InvitePage_bannerText' style={{fontSize:'16px', color:'#333', textAlign:'right'}}>Um aplicativo criado para conectar você a novos clientes, todo dia</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div style={{width:'100%', height:'fit-content', backgroundColor:'#F2F2F2'}}>                
                <div className='InvitePage_stepsTitle' style={{width:'100%', height:'100px', fontSize:'35px', display:'flex'}}>
                    <div style={{width:'fit-content', height:'fit-content', margin:'auto', fontWeight:'200', color:'black'}}>
                        Como funciona?
                    </div>
                </div>
                <div className='InvitePage_steps' style={{width:'100%', height:'fit-content', paddingBottom:'40px', display:'flex'}}>
                    <div style={{minWidth:'485px', margin:'0 auto', display:'flex'}}>                    
                ...
                <div className='InvitePage_steps2' style={{width:'100%', height:'fit-content', paddingBottom:'20px', display:'none'}}>
                    <div style={{minWidth:'240px', margin:'0 auto', display:'flex'}}>
            ...
            <div style={{width:'100%', height:'fit-content', borderBottom:'1px solid #FF700060', color:'black', display:'flex'}}>
                <div className='InvitePage_infographDiv' style={{width:'fit-content', height:'fit-content', margin:'auto', display:'flex'}}>
                    <div className='InvitePage_infographImg' style={{width:'240px', height:'290px', backgroundImage:'url(/imgs/others/people_chart.png)', backgroundSize:'contain', backgroundPosition:'center', backgroundRepeat:'no-repeat'}}></div>
                    <div className='InvitePage_infographText' style={{width:'535px', height:'fit-content', maxWidth:'680px', paddingTop:'30px', margin:'auto 0', marginLeft:'60px', fontSize:'30px', fontWeight:'200', textAlign:'center'}}>
            ...
            <div style={{width: '100%', height:'fit-content', borderBottom:'1px solid #FF700060', display:'flex'}}>
                <div className='InvitePage_withUsMainDiv' style={{width:'fit-content', height:'fit-content', margin:'0 auto', display:'flex', fontSize:'12px', color:'#555'}}>
                    <div className='InvitePage_withUsSubDiv' style={{width:'fit-content', height:'fit-content', display:'flex'}}>
                        <div className='InvitePage_withUsSubDiv1' style={{width:'290px', height:'180px', display:'flex'}}>
                            <div style={{margin:'auto', paddingTop:'40px'}}>Reduz seus custos</div>
                            <div style={{width:'100px', height:'100%', maxHeight:'180px', margin:'auto', backgroundImage: 'url(/imgs/others/pig_bank.png)', backgroundSize:'contain', backgroundPosition:'center', backgroundRepeat:'no-repeat'}}></div>
                        </div>
                        <div className='InvitePage_withUsSubDiv2' style={{width:'240px', height:'180px', display:'flex'}}>
                            <div style={{width:'175px', margin:'auto', paddingTop:'40px', paddingRight:'15px', textAlign:'center'}}>Acelera o crescimento da sua empresa alavancando<br/>suas vendas</div>
                            <div style={{width:'100px', height:'100%', maxHeight:'180px', margin:'auto', backgroundImage:'url(/imgs/others/graph_bar.png)', backgroundSize:'contain', backgroundPosition:'center', backgroundRepeat:'no-repeat'}}></div>
                        </div>
                    </div>                    
                    <div className='InvitePage_withUsEndDiv' style={{width:'215px', height:'180px', paddingTop:'20px', display:'flex'}}>
                        <div style={{width:'170px', margin:'auto', textAlign:'center'}}>Amplia sua rede de contatos e torna-se cada vez mais conhecido pelo público</div>  
                    </div>
                </div>                
            </div>
            <div style={{width:'100%', margin:'0 auto', maxWidth:'500px'}}>
                <div style={{width:'auto', marginTop:'40px', padding:'0 10px'}}>
                    ...
                    <div className='InvitePage_formDiv' style={{display:'flex'}}>
                        <div className='InvitePage_nameDiv' style={{width:'50%', padding:'0 5px', marginTop:'15px', display:'flex'}}>
                            <input style={{width:'100%', height:'30px', padding:'0px 20px', margin:'0px', lineHeight:'30px', textAlign:'center', border:'1px solid #FF7000', borderRadius:'3px', backgroundColor:'white'}} name='nome' value={this.state.nome} placeholder='NOME COMPLETO' onChange={(e)=>{this.inputHandler(e)}}/>
                        </div>
                        <div className='InvitePage_phoneDiv' style={{width:'50%', padding:'0 5px', marginTop:'15px', display:'flex'}}>
                            <input style={{width:'100%', height:'30px', padding:'0px 20px', margin:'0px', lineHeight:'30px', textAlign:'center', border:'1px solid #FF7000', borderRadius:'3px', backgroundColor:'white'}} name='celular' value={this.state.celular} placeholder='CELULAR' onChange={(e)=>{this.inputHandler(e)}}/>
                        </div>
                    </div>                    
                    <div className='InvitePage_emailDiv' style={{marginTop:'20px', padding:'0 5px', display:'flex'}}>
                        <input style={{width:'100%', height:'30px', padding:'0px 20px', margin:'0px', lineHeight:'30px', textAlign:'center', border:'1px solid #FF7000', borderRadius:'3px', backgroundColor:'white'}} name='email' value={this.state.email} placeholder='E-MAIL' onChange={(e)=>{this.inputHandler(e)}}/> 
                    </div>                 
                    {this.displayErrors()}
                    {this.displaySuccess()}
