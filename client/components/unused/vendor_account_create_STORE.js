...
class VendorCreateStoreAccountPage extends Component {
    constructor(props){
        super(props);
        this.errors = [];
        this.state = {
    ...
    validateInputs(){
        ...
        if (this.state.storeName.length < 2){ this.errors.push('Preecha o campo Nome da Loja para se registrar.'); }
            ...
            <div style={{width:'100%', margin:'0 auto', maxWidth:'670px'}}>
                <div style={{width:'100%', marginTop:'40px'}}>
                    ...
                    <div style={{marginTop:'10px'}}>
                        <CustomInput width='auto' height='30px' inputStyle={{textAlign:'center'}} name='storeName' value={this.state.storeName} placeholder='NOME DA LOJA' onChange={(e)=>{this.inputHandler(e)}}/>
                    </div> 
                    <div style={{marginTop:'10px'}}>
                        <CustomInput width='auto' height='30px' inputStyle={{textAlign:'center'}} name='cnpj' value={this.state.cnpj} placeholder='CNPJ' onChange={(e)=>{this.inputHandler(e)}}/>
                    </div> 
...
export default VendorCreateStoreAccountPage;